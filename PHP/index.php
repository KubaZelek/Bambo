                 ...
                 if ($baza->connect_error) {
                    ...
                    if (isset($_POST['search-bar'])) {
                     ...
                     echo '</div>';
                      ...
                      <a href="#" class="offer">
                        <img class="ad-image" src="../images/bluza-meska.jpg" alt="przykladowe zdjecie oferty" />
                        <div class="ad-details">
                          <p class="offer-name">Bluza 2115 podpisana przez bediego</p>
                          <p class="price">12zł</p>
                        </div>
                      </a>
                      <a href="#" class="offer">
                        <img class="ad-image" src="../images/bluza-meska.jpg" alt="przykladowe zdjecie oferty" />
